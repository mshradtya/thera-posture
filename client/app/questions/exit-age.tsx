  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.topBarTitle}>Age Requirement</Text>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.messageContainer}>
          ...
          <Text style={styles.message}>
            We're sorry, but Thera-Posture is designed for individuals 12 years
            of age and older. For younger users, we recommend consulting with a
            healthcare professional for appropriate posture advice.
          </Text>
          ...
          <View style={styles.benefitsContainer}>
            <Text style={styles.benefitsTitle}>Alternative Options:</Text>
