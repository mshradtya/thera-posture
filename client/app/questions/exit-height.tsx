        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.contentCard}>
            ...
            <Text style={styles.message}>
              ...
              (4'7"-6'11"). Your height falls outside this range, which means
              our standard solutions may not provide optimal support for you.
            </Text>
            ...
            <View style={styles.infoContainer}>
              <View style={styles.infoHeader}>
                <Ionicons
                  ...
                  color={Colors.error}
                />
                <Text style={styles.infoTitle}>Why Height Matters</Text>
              </View>
